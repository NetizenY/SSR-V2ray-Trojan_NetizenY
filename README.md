# SSR-V2ray-Trojan机场推荐 **以及NetizenY的个人使用体验**


本fork旨在记录NetizenY对于部分机场的个人使用体验，本人不了解机场入口、线路类型、传输协议、自定义脚本等方面的知识，但会通过搜寻网路尽量为各位提供完整的参考信息。

## 一、EdNovas云
- [EdNovas云介绍与评测](#十七EdNovas云10月50G)

全部节点采用Vmess协议。有TG交流群，机场主人挺好的，有类家宽（台湾、香港、日本）节点，提供多种倍率的节点并且不会出现低倍率节点用不了，只有高倍率节点能用的情况。缺点是沪日隧道的节点最近经常受到攻击，导致美国/日本节点都用不了😢 规则写的很好，使用clash的规则自定义程度很高，不会莫名其妙地接管国内流量，缺点是Android如果全球直连Tab下选择DIRECT则将无法使用Microsoft Copilot。没有承诺ChatGPT解锁，但实测大部分节点都解锁了GPT。部分节点支援流媒体解锁。


## 二、老猫云
- [老猫云介绍与评测](十二老猫云15月50G)

全部节点采用Trojan协议。这个机场挺佛系的，限制不多，也没有高低倍率节点的区分，规则写的中规中矩，自定义程度不高，会接管国内和Microsoft和Steam的下载流量导致流量用得特别快，但只要在下载时注意一下关掉就没问题。可以访问ChatGPT。


## 三、FlyingBird飞鸟机场
- [FlyingBird飞鸟机场介绍与评测](十五Flyingbird15月100G)

Shadowsocks节点，原生度很低，很离谱地，日本节点的服务器地址甚至位于洛杉矶。不区分高低倍率节点。但优点就是节点多速度快而且便宜，不追求高原生度首推FlyingBird。大部分节点可以访问ChatGPT。


## 四、GLaDOS

**GLaDOS 是一家稳定运营超过5年的 翻墙机场，提供 V2ray 专用翻墙协议（支援 Shadowsocks、Vmess 、Vless 以及 Trojan ），更有 Wire Guard VPN协议，线路针对中国大陆进行优化，可以满足翻墙者日常上网、工作和学习需求。GLaDOS 机场除了支持常见设备之外，还额外支持游戏主机加速，官方有详细教程，翻墙者可参考文档自助配置主机翻墙方案。GLaDOS 最低价格约￥29每月，支持多种付款方式，包含支付宝、Paypal和信用卡付款方式。**

**注册 GLaDOS 账号，默认开启试用，使用一段时间后才能进行套餐升级。**

Trojan协议节点，节点数量一般，各节点延迟很低（clash测得延迟稳定低于250ms），然而实际体验速度并不快，不清楚是为什么。可以访问ChatGPT和Microsoft Copilot，有NetFlix专用节点。提供基于Netch的游戏加速服务，但实测不能游玩Apex，也不能加速Switch（通过电脑热点）（可能是因为我用的是校园网），其余的在线游戏我不玩所以暂时没有测试，不过可以访问Steam商店。

价格如下图所示

<img width="1186" alt="image" src="https://github.com/NetizenY/SSR-V2ray-Trojan_NetizenY/assets/61308071/7a733b50-4632-4f17-a8be-4a518f08c031">


![12f829d722f5963be2a8592595641436](https://github.com/NetizenY/SSR-V2ray-Trojan_NetizenY/assets/61308071/10e659ae-eb9d-47ff-831b-61150f4ea0ef)
...
套餐价格是否包含手续费：包含
只能内地使用：是     
注意事项：提前用完流量直接续费/购买相同套餐不会马上重置流量。购买流量包才可，流量叠加包在您套餐流量重置时会一起清零。         
<a href="https://jichangcesu.com/cyanmori青森云机场怎么样.html" target="_blank">使用教程、拓扑结构、ChatGPT解锁和流媒体检测和历史测速结果合集</a>
...
[Haita机场官网地址](https://haita.link/reguser?aff=VQq8ZO5j)
...
[Sayss机场官网](https://www.sayss.net/#/register?code=yv7SoTwk)
...
### Totorocloud      
专线中转SS机场    
月付/季度/半年 ，享受85折优惠，优惠码： longmao85    
年付以及以上，享受8折优惠，优惠码：longmao80    
有效期：至2024年5月15号23：59    
折后：12.75/月100G    
...
### 一云梯      
月/季/半年/年付 8折 , 优惠码：5120%    
有效期：至2024年5月20日23点59分    
折后：12.75/月 100G    
...
支持Vmess/V2ray（支持客户端：不支持shadowrocksR，支持clash系列、v2rayN、v2raNG、surfoard、小火箭shadowrocket、quanmultX、loon、stash、surge、sing-box、hiddify、nekoray、nekobox等）：Kycloud、EdNovas云、Just my sock       
  ...
  3.**屏蔽限制区分：**
   未屏蔽22端口：Sayss、SpeedCAT、Kycloud、EdNovas云、Just my sock、芬达 、Cyanmori 、老猫云、haita、一云梯（15/月10G）           
   可用第三方软件发邮件：Sayss、Kycloud、EdNovas云、Just my sock、芬达、Taishan 、老猫云、一云梯（15/月10G）       
   审计较少：Just my sock、Sayss、Kycloud、EdNovas云、Taishan、Cyanmori、老猫云、一云梯（15/月10G）    


4. **落地国家节点多**，买TAG、EdNovas云(冷门节点比不过TAG), Sayss、悠兔、flyingbird也有部分冷门节点；

5. **想要家宽**:TAG、EdNovas云

6. **支持虚拟币（虚拟币支付注意会有1U手续费，到账金额需要和显示的一样）**： Kycloud、EdNovas云、飞鸟。注意到账金额需要和显示的一样，币安和okx会从转载金额里面扣1U手续费。
