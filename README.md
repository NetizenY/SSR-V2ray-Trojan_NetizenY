...
本fork旨在记录NetizenY对于部分机场的个人使用体验，本人不了解机场入口、线路类型、传输协议等方面的知识，但会通过搜寻网路尽量为各位提供完整的参考信息。

## 一、EdNovas云
- [EdNovas云介绍与评测](#十七EdNovas云10月50G)

有TG交流群，机场主人挺好的，有类家宽节点，提供多种倍率的节点并且不会出现低倍率节点用不了，只有高倍率节点能用的情况。缺点是沪日隧道的节点最近经常受到攻击，导致美国/日本节点都用不了😢
